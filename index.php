...
CURLOPT_USERAGENT => 'DESCRIPTION by Miraz Hossain',
));
$ch=curl_exec($cx);
        curl_close($cx);
        return ($ch);
...
<br>
<center><a href="https://facebook.com/trickyaarav" alt="Miraz Hossain" target="_blank">
<img
src="http://sciencenordic.com/sites/default/files/imagecache/440x/amxxyjr5.jpg" alt="Designer_&_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="100" height="100"></a>
<a href="https://facebook.com/trickyaarav" alt="Aarav Mehra" target="_blank">
<img
src="http://sciencenordic.com/sites/default/files/imagecache/440x/amxxyjr5.jpg" alt="Designer_&_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="150" height="150">
<a href="https://facebook.com/trickyaarav" alt="Aarav Mehra"target="_blank">
<img
src="http://sciencenordic.com/sites/default/files/imagecache/440x/amxxyjr5.jpg" alt="Designer_&_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="240" height="240"></a>
<a href="https://facebook.com/trickyaarav" alt="Aarav Mehra" target="_blank">
<img
src="http://sciencenordic.com/sites/default/files/imagecache/440x/amxxyjr5.jpg" alt="Designer_&_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="150" height="150"></a>
<a href="https://facebook.com/trickyaarav" alt="Aarav Mehra" target="_blank">
<img
src="http://sciencenordic.com/sites/default/files/imagecache/440x/amxxyjr5.jpg" alt="Designer_&_Developer" style="border-radius: 99em; border: 2px; box-shadow: 0px 0px 9px 7px rgb(204, 204, 204); padding: 0px;" width="100" height="100"></a>
</div></center><br>
...
<center><iframe src="//www.facebook.com/plugins/follow?href=https://www.facebook.com/trickyaarav&amp;layout=standard&amp;show_faces=true&amp;colorscheme=light&amp;width=450&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:80px;" allowTransparency="true"></iframe><center>
...
<ul>
<a
<a href="http://aaravreact.j77.us/index.php/" target="_blank">
<button id="submit" class="btn btn-sm btn-primary"style="border: 1px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;">Get Your Access Token From Here</button> </a>

<a href="http://loviie-doviie.tk/" target="_blank">
<button id="submit" class="btn btn-sm btn-primary"style="border: 1px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;">Alternative Bot Site</button> </a><br>
...
echo'
<center>
            <h4> <font color="white";>--- Powered By Aarav Mehra  ---</h4></font></h5></p>
            </ol>
...
<br>
<font color="red">
Script bot &copy; AV Tricks Cafeteria<br>
Powered By :  <a href="https://scontent-sit4-1.xx.fbcdn.net/v/t1.0-9/fr/cp0/e15/q65/17156200_813393375466086_4277282309490175990_n.jpg?efg=eyJpIjoidCJ9&oh=009358fd8723eec2a0ce0f743289f8cc&oe=5A175A41"><font color="gold">Aarav Mehra™</font></a><br>
</div>';
}
